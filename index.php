      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="resume-item pb-0">
            <h4>Ujwol Shrestha</h4>
            <p><em>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus aperiam doloremque ad repudiandae! Eveniet est suscipit esse rem non, provident officia laboriosam ullam saepe eum aliquam aut vero illo hic.
            <ul>
              <li>thaiba 123,Lalitpur, Nepal</li>
              <li>1234567890</li>
              <li>Ujwol.shrestha@example.com</li>
            </ul>
            </p>
          </div>
          ...
          <div class="resume-item">
            <h4>Bachelor in Computer Application <!--&amp; Graphic Design--></h4>
            <h5>2018 - 2023</h5>
            <p><em>Nepal College of Information Technology, Balkumari, Lalitpur</em></p>
        ...
        <div class="col-lg-6">
          ...
          <div class="resume-item">
            <h4>L1 Technical Support For Dishhome</h4>
            <h5>2022 - 2023t</h5>
            <p><em>Ekantakuna, Lalitpur, Nepal </em></p>
            <p>
            <ul>
              <li>Initial point of contact: L1 support is the first line of assistance, providing immediate solutions to common user issues.</li>
              <li>Basic troubleshooting: L1 support addresses routine problems, including software installations, account setups, and general user inquiries. </li>
              <li>Ticket routing: L1 support appropriately categorizes and escalates issues to higher support levels when necessary.</li>
              <li>Specialized knowledge: L1 support technicians possess specialized knowledge in specific areas, allowing them to tackle intricate problems with expertise.</li>
            </ul>
            </p>
          </div>
